...
namespace TareasMVC.Controllers
{
    public class UsuariosController : Controller
    {
            ...
            string remoteError = null)
        {
            ...
            {
                mensaje = "Error leyendo el correo del usuario del proveedor";
                return RedirectToAction("login", routeValues: new { mensaje });
            }
            ...
            {
                await signInManager.SignInAsync(usuario, isPersistent: true, info.LoginProvider).ConfigureAwait(false);
                return LocalRedirect(urlRetorno);
            }

            mensaje = "Ha ocurrido un error en el inicio de sesion";
            return RedirectToAction("login", routeValues: new { mensaje });
        }
